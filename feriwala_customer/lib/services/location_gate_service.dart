    ...
    while (true) {
      ...
      if (!serviceEnabled) {
        await _showBlockingDialog(
          ...
          message: 'Feriwala needs your device GPS to find nearby shops and deliver to your address.\n\nPlease enable Location in your phone settings.',
      ...
      if (status.isPermanentlyDenied) {
        await _showBlockingDialog(
          ...
          message: 'Feriwala needs location access to find shops near you and deliver to your address.\n\nPlease go to App Settings → Permissions → Location → Allow while using app.',
